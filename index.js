export const wable = {
    ...
    emoticonToEmoji: (i) => {
        let x = i;
        for (let c = 0; c < wable.emoticonList.length; c++) {
            if (i.includes(wable.emoticonList[c])) {
                x = x.replaceAll(wable.emoticonList[c], wable.emoticonEmojiList[c]);
            }
        }
    ...
    emojiToEmoticon: (i) => {
        let x = i;
        for (let c = 0; c < wable.emoticonEmojiList.length; c++) {
            if (i.includes(wable.emoticonEmojiList[c])) {
                x = x.replaceAll(wable.emoticonEmojiList[c], wable.emoticonList[c]);
            }
        }
